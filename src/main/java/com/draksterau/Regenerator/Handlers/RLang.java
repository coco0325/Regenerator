...
public final class RLang extends RObject {
    ...
    void loadData() {
        ...
        if (!langConfigFile.exists()) {
            langConfigFile = new File(plugin.getDataFolder() + "/lang/" + this.language + ".yml");
                if (plugin.getResource(this.language + ".yml") != null) {
                    langConfig = YamlConfiguration.loadConfiguration(new InputStreamReader(plugin.getResource(this.language + ".yml")));
                } else {
    ...
    public YamlConfiguration getDefaultLanguage() {
        return YamlConfiguration.loadConfiguration(new InputStreamReader(plugin.getResource("ENGLISH.yml")));
    }
    ...
    public String getForKey(String key) {
            try {
                ...
                if (value == null) {
                    ...
                    langConfigTemp = YamlConfiguration.loadConfiguration(new InputStreamReader(plugin.getResource(this.language + ".yml")));
                    if (langConfigTemp.isSet(key)) {
                        ...
                        langConfigTemp = YamlConfiguration.loadConfiguration(new InputStreamReader(plugin.getResource("ENGLISH.yml")));
                        if (langConfigTemp.isSet(key)) {
